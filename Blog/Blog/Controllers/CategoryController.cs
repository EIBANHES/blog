    ...
    public class CategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> PostAsync([FromBody] EditorCategoryViewModel model, [FromServices] BlogDataContext context)
        {
            ...
            if (!ModelState.IsValid)
                return BadRequest(new ResultViewModel<Category>(ModelState.GetErrors())); // precisa colocar pq desabilitamos isso no program.cs
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05X09 - Não foi possivel incluir a categoria"));
            }
            catch
            {
        ...
        public async Task<IActionResult> PutAsync([FromRoute] int id, [FromBody] EditorCategoryViewModel model, [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05X08 - Não foi possivel alterar a categoria"));
            }
            catch
            {
        ...
        public async Task<IActionResult> DeleteAsync([FromRoute] int id, [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05X07 - Não foi possivel deletar a categoria"));
            }
            catch
            {
